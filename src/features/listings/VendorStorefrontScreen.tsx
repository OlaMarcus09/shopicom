...
const styles = StyleSheet.create({
  ...
  stats: { width: '100%', flexDirection: 'row', justifyContent: 'space-around', marginTop: 25 }, statValue: { color: '#F1645E', fontSize: 23, fontWeight: '700', textAlign: 'center' }, statLabel: { color: '#666', fontSize: 13, fontWeight: '600', marginTop: 3 }, bio: { color: '#777', fontSize: 14, marginTop: 22 }, actions: { width: '100%', flexDirection: 'row', gap: 10, paddingHorizontal: 20, marginTop: 24 }, follow: { flex: 1, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#F45100' }, followText: { color: '#FFF', fontSize: 16, fontWeight: '700' }, message: { width: 60, height: 48, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#F45100', borderRadius: 15 }, messageIcon: { color: '#F45100', fontSize: 25 }, whatsapp: { minWidth: 92, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#16A269', paddingHorizontal: 10 }, whatsappText: { color: '#FFF', fontSize: 12, fontWeight: '800' },
